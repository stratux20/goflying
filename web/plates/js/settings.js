...
function SettingsCtrl($rootScope, $scope, $state, $location, $window, $http) {
	...
	var toggles = ['UAT_Enabled', 'ES_Enabled', 'OGN_Enabled', 'AIS_Enabled', 'Daisy_Enabled', 'APRS_Enabled', 'Ping_Enabled', 'OGNI2CTXEnabled', 'GPS_Enabled', 'IMU_Sensor_Enabled',
	...
	function loadSettings(data) {
		...
		$scope.Daisy_Enabled = settings.Daisy_Enabled;
